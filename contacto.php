...
?>
    ...
    <header class="page-header contact-header">
        ...
        <div class="header-content fade-in-up">
            <h1>ESTAMOS <span class="text-gold">CERCA DE TI</span></h1>
            <p>¿Dudas, comentarios o antojo? Escríbenos.</p>
        </div>
    </header>
        ...
        <div class="container">
            <div class="contact-grid fade-in-up">
                ...
                <div class="contact-box">
                    ...
                    <h3>UBICACIÓN</h3>
                    <p>Av. Los Pinos, Joyas de Anahuac</p>
                    <p>Cdad. Gral. Escobedo, N.L.</p>
                </div>
